...
const Login = () => {
  return (
    <div className="flex justify-center items-center">
      <div class="w-full max-w-sm p-6 m-auto mx-auto my-12 bg-white rounded-lg shadow-md ">
        ...
        <form class="mt-6">
          ...
          <div class="mt-4">
            ...
            <input
              type="password"
              class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg   focus:border-blue-400focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400">
          ...
          <Link to="/reg" class="font-medium text-gray-700  hover:underline">
            Create One
          </Link>
        </p>
      </div>
